...
type Config struct {
	...
	Watcher  watcher.Config  `yaml:"watcher,omitempty"`
	Syncer   syncer.Config   `yaml:"syncer,omitempty"`
	Hasher   hasher.Config   `yaml:"hasher,omitempty"`
}
...
func (c *Config) RegisterFlagsAndApplyDefaults(prefix string, f *flag.FlagSet) {
	...
	// Modules
	c.Operator.RegisterFlagsAndApplyDefaults(util.PrefixConfig(prefix, "operator"), f)
